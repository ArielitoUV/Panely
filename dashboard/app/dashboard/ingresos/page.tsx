    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="text-center space-y-6 max-w-md">
        ...
        <div className="space-y-3">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground">Ingresos</h1>
          <p className="text-lg text-muted-foreground">Esta sección está en construcción</p>
          <p className="text-sm text-muted-foreground/80">Pronto podrás registrar y gestionar todos tus ingresos</p>
        </div>
